//+--------------------------------------------------------------------------
//
//  dxgiformat.h - mirrored from the Windows SDK (shared/dxgiformat.h).
//
...
#ifndef DWC_MIRROR_DXGIFORMAT_H
#define DWC_MIRROR_DXGIFORMAT_H
#pragma once
