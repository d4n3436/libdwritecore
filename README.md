...
| `DWRITECORE_FIREFOX_PARITY`  | `ON`                                          | Compile the parity path in.                                                                                                                 |
...
| `CLEARTYPE_FORCE_PARITY`           | `auto`                         | `auto` applies parity behavior to a Gecko process and nothing else. `1` applies it to whatever loaded the library, `0` to nothing.                                                   |
